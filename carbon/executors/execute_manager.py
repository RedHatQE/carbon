...
"""
    ...
    This is a generic interface that processes carbon's execute tasks.
...
class ExecuteManager(LoggerMixin, TimeMixin):
    ...
    def run(self):
        ...
        if res == 0:
            ...
            raise CarbonExecuteError("Execute stage failed : Failed to perform %s" % self.plugin.execute_name)
