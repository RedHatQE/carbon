...
class Notification(CarbonResource):
    ...
    def __init__(self,
        ...
        :param notification_task_cls: carbons notification task class
        ...
        if name is None:
            ...
            if self._name is None:
                raise CarbonResourceError('Unable to build notification object. Name'
                                          ' field missing!')
        else:
            self._name = name
        ...
        if notifier in get_notification_plugin_list():
            ...
            raise CarbonResourceError('The specified notification, %s, does not exist.' % notifier)
