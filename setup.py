...
setup(
    ...
    extras_require={'linchpin-wrapper': ['carbon_linchpin_plugin@git+https://gitlab.cee.redhat.com/ccit/carbon/plugins/carbon_linchpin_plugin.git@1.0.0#egg=carbon_linchpin_plugin']},
    classifiers=[
