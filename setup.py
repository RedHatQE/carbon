...
setup(
    ...
    extras_require={'linchpin-wrapper': ['carbon_linchpin_plugin@git+https://gitlab.cee.redhat.com/ccit/carbon/plugins/carbon_linchpin_plugin.git@1.0.1#egg=carbon_linchpin_plugin'],
                    'openstack-client-plugin':['carbon_openstack_client_plugin@git+https://gitlab.cee.redhat.com/ccit/carbon/plugins/carbon_openstack_client_plugin.git@1.1.1#egg=carbon_openstack_client_plugin']
                    },
    classifiers=[
