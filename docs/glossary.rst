...
.. glossary::
    ...
    credentials (section)
        ...
        provisioned. Credentials are set in carbon.cfg file. They are
    ...
    section (carbon)
        ...
        particular component within carbon. Valid sections are 'Resource Check',
        Credentials, Provision, Orchestrate, Execute and Report.

    scenario (carbon)
        A carbon scenario descriptor file. Carbon input file. SDF.
    ...
    task (orchestrate)
         ...
         The default orchestrator for carbon is Ansible.
