...
This topic focuses on how you can pass data between different tasks of carbon.

Orchestrate
-----------

Carbon's orchestrate task is focused with one goal, to configure your test
...
way is not recommended by carbon. Carbons scenario descriptor file allows
...
Carbon's execute task is focused with one goal, to execute the tests defined
...
address as a parameter option for a test command? Carbon has the ability to
...
Carbon will evaluate the test command performing the templating (setting the
