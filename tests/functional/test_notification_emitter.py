...
"""
    ...
    Unit tests for testing carbon asset provisioner class.
...
from carbon.resources import Notification
from carbon.core import NotificationPlugin
from carbon.notifiers import Notifier
