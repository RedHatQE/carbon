...
#
"""
    carbon.provisioners.openstack_v2

    Next gen for carbon framework openstack provisioner. This provisioner
    uses the openstack_v2 provider that utilizes apache libcloud.
...
class OpenstackProvisionerV2(CarbonProvisioner):
    ...
    """
    __provisioner_name__ = 'openstack_v2'
    ...
    def __init__(self, host):
        ...
        """
        super(OpenstackProvisionerV2, self).__init__()
        self.host = host
