...
#
"""
    carbon.providers.openstack_v2

    Next gen for carbon framework openstack provider. It utilizes
    apache libcloud instead of the native openstack sdk libraries. At some
    point the version 1.0 openstack module will be depreciated. With this
    module you only need to define the following credential keys:
        - username
        - password
        - auth_url
    ...
    The auth_url does not need to include the api version just the port.

    For more details please visit the following link and select LibCloud in
    the table.
...
class OpenstackProviderV2(CarbonProvider):
    """
    ...
    """
    __provider_name__ = 'openstack_v2'
    ...
    def __init__(self, **kwargs):
        ...
        :type kwargs: dict
        """
        super(OpenstackProviderV2, self).__init__(**kwargs)
